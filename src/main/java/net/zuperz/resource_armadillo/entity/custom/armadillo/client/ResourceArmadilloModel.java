...
public class ResourceArmadilloModel extends AgeableHierarchicalModel<ResourceArmadilloEntity> {
    ...
    public ResourceArmadilloModel(ModelPart pRoot) {
        super(0.6F, 16.02F);
        this.root = pRoot;
     ...
     */
    public void setupAnim(ResourceArmadilloEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
